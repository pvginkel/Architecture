...
- **No defensive coding.** No try/catch that swallows errors, no silent fallbacks for data the dataset/schema already guarantees. Fail loudly; prefer obvious-now failure over silent-corruption-later.
